    ...
    <div className="flex flex-col items-center gap-1">
      ...
      <div className="flex flex-col border border-ink">
        <button
          ...
          className="w-[52px] h-6 border-b border-rule font-mono text-[11px] text-inkSoft hover:bg-panelHover focus-visible:outline focus-visible:outline-1 focus-visible:outline-accent -outline-offset-1"
        >
          ▲
        </button>
        <span
        ...
        <button
          ...
          className="w-[52px] h-6 border-t border-rule font-mono text-[11px] text-inkSoft hover:bg-panelHover focus-visible:outline focus-visible:outline-1 focus-visible:outline-accent -outline-offset-1"
        >
          ▼
        </button>
      </div>
